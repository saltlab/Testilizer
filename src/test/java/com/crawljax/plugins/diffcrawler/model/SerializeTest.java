package com.crawljax.plugins.diffcrawler.model;
...
import com.crawljax.plugins.diffcrawler.model.Edge;
...
import com.crawljax.plugins.diffcrawler.model.StateStatistics;
import com.crawljax.plugins.diffcrawler.model.Statistics;
...
public class SerializeTest {
	...
	public void testConfigSerializibility() throws IOException {
		...
		builder.addPlugin(new DiffCrawler(tmpFolder.getRoot()));
